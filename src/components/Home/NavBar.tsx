...
const NavBar = (props:any) => {
    ...
    return (
      <nav
        className="NavBar"
        // id={props.navState ? "scrolled" : "notScrolled"}
      >
        ...
        <div className="LogoBox" onClick={() => props.scrollTo(props.refs.Home)}>
        ...
        <ul className={NavBarOpened ? "toggled" : "notToggled"}>
          <li onClick={() => props.scrollTo(props.refs.About)}>
            ...
            <a href="#About" onClick={() => setNavBar(true)}>
              {t("NavBar.About")}
            </a>
          </li>
          <li onClick={() => props.scrollTo(props.refs.Begin)}>
            <div className="SvgContainer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            <a href="#Begin" onClick={() => setNavBar(true)}>
              {t("NavBar.Begin")}
            </a>
          </li>
          <li onClick={() => props.scrollTo(props.refs.Contacts)}>
            <div className="SvgContainer">
              <svg
                width="24"
                height="24"
            ...
            <a href="#Contact" onClick={() => setNavBar(true)}>
              {t("NavBar.ContactUs")}
            </a>
          </li>
          <li>
