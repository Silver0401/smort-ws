      ...
      <section className="Block1">
        ...
        <span className="WhyBox">
          ...
          <span className="Reasons" id="About">
            ...
            <div className="Box5">
              <h2>{t("Block1.Box5.title")}</h2>
              <p>{t("Block1.Box5.par")}</p>
              <span className="SvgBox">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
            ...
            <div className="Box8">
              <h2>{t("Block1.Box8.title")}</h2>
              <p>{t("Block1.Box8.par")}</p>
              <span className="SvgBox">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
